...
<?php
    ...
    if($_GET['action'] == "reduce"){//判断地址栏参数action的值是否等于update
...
?>
  <div class="top">兑换积分</div>
    <form name="intFrom" method="post" action="reduce_ok.php" style="width: 398px;border: 1px solid #cccc">
    ...
    <table>
      ...
      <td class="c_td">&nbsp;</td>
            ...
            <td align="center" valign="middle" class="c_td"><input type="text" name="reduce_item" oninput="value=value.replace(/[^\d]/g,'')"></td>
            <td class="c_td">&nbsp;</td>
      </tr>
         <tr>
      <td class="c_td">&nbsp;</td>
            <td align="right" valign="middle" class="c_td">兑换说明：</td>
      ...
      <td class="c_td">&nbsp;</td>
            ...
            <td align="center" valign="middle" class="c_td"><input type="text" name="add_item" value="0"></td>
            <td class="c_td">&nbsp;</td>
      </tr>
      <tr align="center" valign="middle">
      <td class="c_td">&nbsp;</td>
