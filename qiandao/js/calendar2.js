...
var calUtil = {
      ...
      //添加选中的天数
       ...
       var day =parseInt($(this).html());
         ...
         var xhr = new XMLHttpRequest();
          xhr.open('get','sign.php?signday='+day+'&&id='+scriptArgs);
          xhr.onload = function(){
  ...
  drawCal : function(iYear, iMonth ,signList) {
   ...
   htmls.push("<a href='javascript:history.back(-1)' style='text-decoration:none'><div class='sign_succ_calendar_title'>");
