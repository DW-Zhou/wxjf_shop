...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center"><table width="700" border="0">
	  ...
	  $result=mysqli_query($conn,"select * from jifen_user");
      ...
      <tr>
        ...
        <td align="center"><span class="STYLE2"><?php echo $myrow[3]; ?></span></td>
        <td align="center"><span class="STYLE2"><?php echo $myrow[4]; ?></span></td>
         <td align="center"><span class="STYLE2"><?php echo $myrow[5]; ?></span></td>
        <td align="center"><span class="STYLE2"><?php echo $myrow[6]; ?></span></td>
        <td align="center"><span class="STYLE2"><?php echo $myrow[7]; ?></span></td>
          <td align="center"><span class="STYLE2"><?php echo $myrow[8]; ?></span></td>
        <td align="center"><span class="STYLE2"><?php echo $myrow[9]; ?></span></td>
        <td align="center"><span class="STYLE2"><?php echo $myrow[10]; ?></span></td>
      </tr>
	  <?php
	  }
	  ?>
