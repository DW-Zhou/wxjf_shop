        ...
        <section class="phone-register">
          ...
          <!--   <div class="register-item">
                <div class="inputs ">
                    ...
                    <input type="text" class="form-control" id="pwd" name="pwd" style="width: 9rem" />
            ...
            <!-- 总积分 -->
             <div class="register-item" style="display: none">
                <div class="inputs ">
                    <label for="total_intergral">总积分：</label>
                    <input type="text" class="form-control" name="total_intergral" id="total_intergral"/>
                </div>
            </div>
             <div class="register-item" style="display: none">
                <div class="inputs ">
                    <label for="total_intergral">已兑换积分：</label>
                    <input type="text" class="form-control" name="exchange_intergral" id="exchange_intergral"/>
                </div>
            </div>
